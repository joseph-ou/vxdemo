<template>
  <div class="container">
    ...
    <el-card  class="box-card box-item" shadow="hover" :body-style="{width:'100%',padding:'20px'}">
      ...
      <div class="item  flex-row-center">公众号</div>
      <div class="item flex-row-center">
        <div  class="item flex-row-between" style="width: 100px;font-size: 12px;">
      ...
      <div class="item small  flex-row-between">
        ...
        <div  class="date">2024-11-11到期</div>
      </div>
      <div class="item small flex-row-between"></div>
