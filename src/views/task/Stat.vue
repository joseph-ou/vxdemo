...
export default {
  ...
  mounted() {
    Highcharts.setOptions({
      credits: { enabled: false }, // 禁用 Highcharts 水印
    });
    // this.opt1.series[0].data = [5, 4, 3, 2, 1];
    // console.log('-----',this.$refs.optest1)
  }
...
<!--        <highcharts :options="opt1" style="height: 330px;min-width: 300px">-->
        <highcharts ref="optest1" :options="simpleOpt" style="height: 330px;min-width: 300px"></highcharts>
      </el-card>
